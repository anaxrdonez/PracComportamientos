...
public class AnimalUS : MonoBehaviour
{
    ...
    [Tooltip("Valor inicial de energ�a (0 = sin energ�a, 1 = energ�a completa)")]
    ...
    // Referencias a puntos de inter�s
    ...
    IEnumerator IrYEsperar(Transform destino, EstadoAnimal accionFinal)
    {
        ...
        // Cambiar sprite seg�n la acci�n final
        switch (accionFinal)
        {
